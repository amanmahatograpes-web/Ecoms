...
const Inventory = ({ refreshTrigger }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-3 sm:p-4 md:p-5 lg:p-6 xl:p-8">
      ...
      <div className="mb-4 sm:mb-6 lg:mb-8">
        <div className="flex overflow-x-auto pb-2 lg:grid lg:grid-cols-5 lg:gap-3 lg:overflow-visible lg:pb-0">
          <div className="flex-shrink-0 w-48 sm:w-56 lg:w-auto bg-white border border-gray-200 rounded-xl p-3 sm:p-4">
          ...
          <div className="flex-shrink-0 w-48 sm:w-56 lg:w-auto bg-white border border-gray-200 rounded-xl p-3 sm:p-4">
            ...
            <div className="text-2xl sm:text-3xl font-bold text-purple-600">${stats.totalValue.toLocaleString()}</div>
          </div>
        </div>
      </div>
      ...
      {editProduct && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-50 p-3 sm:p-4">
          <div ref={modalRef} className="bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
